module Set1Data where

import qualified Data.ByteString.Lazy as B
import           Data.Word            (Word8)
import           Lib                  (stringToBytes)

challenge1Input :: [B.ByteString]
challenge1Input = [stringToBytes "49276d206b696c6c696e6720796f757220627261696e206c696b65206120706f69736f6e6f7573206d757368726f6f6d"]

challenge1Output :: Either a B.ByteString
challenge1Output = Right $ stringToBytes "SSdtIGtpbGxpbmcgeW91ciBicmFpbiBsaWtlIGEgcG9pc29ub3VzIG11c2hyb29t\n"


challenge2Input :: [B.ByteString]
challenge2Input = [ stringToBytes "1c0111001f010100061a024b53535009181c"
                  , stringToBytes "686974207468652062756c6c277320657965"
                  ]

challenge2Output :: Either a B.ByteString
challenge2Output = Right $ stringToBytes "746865206b696420646f6e277420706c6179\n"


challenge3Input :: [B.ByteString]
challenge3Input = [stringToBytes "1b37373331363f78151b7f2b783431333d78397828372d363c78373e783a393b3736"]

challenge3Output :: Either a B.ByteString
challenge3Output = Right $ stringToBytes "Cooking MC's like a pound of bacon\n"


challenge4Input :: [B.ByteString]
challenge4Input = [stringToBytes $ unlines
...
challenge7Output :: Either a B.ByteString
challenge7Output = Right $ stringToBytes $ unlines
